...
from paperbanana_cn.i18n import SUPPORTED_LOCALES, get_catalogs, get_translator
from paperbanana_cn.studio.branding import (
    BRAND_LOGO_PATH,
    STUDIO_ASSET_DIR,
    STUDIO_ASSET_MOUNT,
)
from paperbanana_cn.studio.components.shell import (
    build_header,
    build_sidebar,
...
from paperbanana_cn.studio.connections_ui import refresh_connection_editor
from paperbanana_cn.studio.context import StudioContext
from paperbanana_cn.studio.language import locale_ready_js, locale_switch_js
...
from paperbanana_cn.studio.pages.automation import (
    build_batch_page,
    build_orchestrate_page,
    build_sweep_page,
)
from paperbanana_cn.studio.pages.generate import (
    bind_image_options,
    build_diagram_page,
    build_plot_page,
)
from paperbanana_cn.studio.pages.improve import build_continue_page, build_evaluate_page
from paperbanana_cn.studio.pages.settings import build_settings_page
from paperbanana_cn.studio.pages.tools import build_composite_page, build_runs_page
