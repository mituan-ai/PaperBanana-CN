...
from paperbanana_cn.core.utils import ensure_dir, find_prompt_dir, generate_run_id, save_json
...
def run_plot_batch(
    ...
    *,
    ...
    from paperbanana_cn.core.workflow_runner import run_plot_batch as run_shared_plot_batch
