...
from paperbanana_cn.core.types import CritiqueResult, DiagramType
from paperbanana_cn.core.utils import extract_json, load_image, truncate_text
from paperbanana_cn.providers.base import VLMProvider
