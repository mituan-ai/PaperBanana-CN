...
from paperbanana_cn.analytics import (
    load_analytics_records,
    render_markdown_summary,
    summarize_records,
)
from paperbanana_cn.connections.cli import (
    connections_app,
)
from paperbanana_cn.connections.cli import (
...
def _validate_venue_or_exit(venue: Optional[str], venue_dir: Optional[str] = None) -> None:
    ...
    from paperbanana_cn.guidelines.venues import UnknownVenueError, validate_venue
...
def generate(
    ...
    if continue_run is not None or continue_last:
        from paperbanana_cn.core.resume import find_latest_run, load_resume_state
...
def batch_report(
    ...
    from paperbanana_cn.core.batch import write_batch_report
...
def sweep_report(
    ...
    from paperbanana_cn.core.sweep import write_sweep_report
...
def composite(
    ...
    from paperbanana_cn.core.composite import compose_images
...
def plot_batch(
    ...
    from paperbanana_cn.core.batch import load_plot_batch_manifest
    from paperbanana_cn.core.workflow_runner import run_plot_batch
...
def polish(
    ...
    from paperbanana_cn.agents.polish import PolishAgent
    from paperbanana_cn.core.cost_tracker import CostTracker
    from paperbanana_cn.core.utils import find_prompt_dir, load_image, save_image
    from paperbanana_cn.guidelines.methodology import load_methodology_guidelines
    from paperbanana_cn.providers.registry import ProviderRegistry
...
def ablate_retrieval(
    ...
    from paperbanana_cn.core.utils import generate_run_id
...
def ablate_prompts(
    ...
    from paperbanana_cn.evaluation.benchmark import filter_examples
...
def benchmark(
    ...
    from paperbanana_cn.evaluation.benchmark import BenchmarkRunner
...
def runs_list(
    ...
    from paperbanana_cn.studio.runs import list_batch_ids, list_run_ids
...
def runs_show(
    ...
    from paperbanana_cn.studio.runs import load_batch_summary, load_run_summary
...
def guidelines_synthesize(
    ...
    """
    from paperbanana_cn.guidelines.synthesis import GUIDE_TYPES, synthesize_style_guide
...
def venues_init(
    ...
    from paperbanana_cn.guidelines.methodology import load_methodology_guidelines
    from paperbanana_cn.guidelines.plots import load_plot_guidelines
    from paperbanana_cn.guidelines.venues import (
...
def validate_manifest(
    ...
    from paperbanana_cn.core.batch import validate_manifest as _validate
...
def doctor(
    ...
    from paperbanana_cn.doctor import run_doctor
